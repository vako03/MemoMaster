...
class CardCell: UICollectionViewCell {
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            textDescription.topAnchor.constraint(equalTo: labelTitle.bottomAnchor, constant: 0),
            ...
            textDescription.bottomAnchor.constraint(lessThanOrEqualTo: bottomAnchor, constant: -6)
        ])
